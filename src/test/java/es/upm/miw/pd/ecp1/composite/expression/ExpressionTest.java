...
import es.upm.miw.pd.ecp1.composite.expression.Dividir;
import es.upm.miw.pd.ecp1.composite.expression.Expresion;
import es.upm.miw.pd.ecp1.composite.expression.Multiplicar;
import es.upm.miw.pd.ecp1.composite.expression.Numero;
import es.upm.miw.pd.ecp1.composite.expression.Restar;
import es.upm.miw.pd.ecp1.composite.expression.Sumar;
