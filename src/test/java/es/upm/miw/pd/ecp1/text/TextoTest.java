...
import es.upm.miw.pd.ecp1.text.Componente;
import es.upm.miw.pd.ecp1.text.FactoriaCaracter;
import es.upm.miw.pd.ecp1.text.Parrafo;
import es.upm.miw.pd.ecp1.text.Texto;
